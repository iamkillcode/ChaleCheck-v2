    ...
    const fetchResults = async () => {
      ...
      try {
        ...
        data = data.sort((a: Restaurant, b: Restaurant) => {
          if (sortBy === "rating") {
            const aRating = a.reviews.length ? a.reviews.reduce((acc: number, r) => acc + r.rating, 0) / a.reviews.length : 0
            const bRating = b.reviews.length ? b.reviews.reduce((acc: number, r) => acc + r.rating, 0) / b.reviews.length : 0
